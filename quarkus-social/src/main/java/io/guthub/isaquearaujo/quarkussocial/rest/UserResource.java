...
import io.guthub.isaquearaujo.quarkussocial.rest.dto.CreateUserRequest;
import io.guthub.isaquearaujo.quarkussocial.rest.dto.ResponseError;
...
public class UserResource {
    ...
    public Response listAllUsers(){
        PanacheQuery<User> query = this.repository.findAll();
